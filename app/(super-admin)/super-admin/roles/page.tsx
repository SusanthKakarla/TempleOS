...
const roleOrder: RoleCode[] = ["admin", "priest", "committee_member", "volunteer", "devotee"];
    ...
    <main className="min-h-screen bg-muted/20 px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="space-y-4">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="space-y-1">
              ...
              <h1 className="text-2xl font-semibold tracking-normal">Role Catalog</h1>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          <SummaryPanel icon={<BadgeCheck className="size-4" />} label="Catalog" value="5 fixed roles" />
          <SummaryPanel icon={<KeyRound className="size-4" />} label="Authorization" value="Stable codes" />
          <SummaryPanel icon={<ShieldCheck className="size-4" />} label="Scope" value="Platform governed" />
        </section>

        <section className="rounded-md border bg-background">
          <div className="border-b px-4 py-3">
            <h2 className="text-base font-semibold tracking-normal">V0 roles</h2>
...
function capabilitiesFor(role: RoleDefinition): string[] {
  ...
  return capabilities.length > 0 ? capabilities : ["No V0 dashboard permission"];
}
