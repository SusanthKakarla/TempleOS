...
Asset in the **public** area. It defines project behavior, structure, data, or configuration consumed by its dependents.
...
- File size: 1 lines; 0 internal dependencies.
...
`Runtime/framework → public/window.svg → output or side effect`
