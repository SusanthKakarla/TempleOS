# get-tenant-day-start-utc.test.ts

## Basic Information

| Field | Value |
|---|---|
| Full path | `lib/whatsapp/get-tenant-day-start-utc.test.ts` |
| Layer | Testing |
| Category | Test |
...
- Inputs: imports from `vitest`, `./templates`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/whatsapp/templates.ts`
...
- Imports: `lib/whatsapp/templates.ts`
...
`Runtime/framework → lib/whatsapp/get-tenant-day-start-utc.test.ts → lib/whatsapp/templates.ts`
