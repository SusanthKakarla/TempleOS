# message-type.test.ts

## Basic Information

| Field | Value |
|---|---|
| Full path | `lib/whatsapp/message-type.test.ts` |
| Layer | Testing |
| Category | Test |
...
- Inputs: imports from `vitest`, `./message-type`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/whatsapp/message-type.ts`
...
- Imports: `lib/whatsapp/message-type.ts`
...
`Runtime/framework → lib/whatsapp/message-type.test.ts → lib/whatsapp/message-type.ts`
