...
| Field | Value |
|---|---|
| Full path | `lib/whatsapp/errors.test.ts` |
| Layer | Testing |
| Category | Test |
...
- Inputs: imports from `vitest`, `./errors`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/whatsapp/errors.ts`
...
- Imports: `lib/whatsapp/errors.ts`
...
`Runtime/framework → lib/whatsapp/errors.test.ts → lib/whatsapp/errors.ts`
