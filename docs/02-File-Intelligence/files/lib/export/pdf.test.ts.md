...
| Field | Value |
|---|---|
| Full path | `lib/export/pdf.test.ts` |
| Layer | Testing |
| Category | Test |
...
- Inputs: imports from `vitest`, `./pdf`, `./types`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/export/pdf.ts`, `lib/export/types.ts`
...
- Imports: `lib/export/pdf.ts`, `lib/export/types.ts`
...
`Runtime/framework → lib/export/pdf.test.ts → lib/export/pdf.ts / lib/export/types.ts`
