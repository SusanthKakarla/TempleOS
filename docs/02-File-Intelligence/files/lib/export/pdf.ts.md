...
- Inputs: imports from `pdfkit`, `./types`.
- Outputs: exports `buildPdfBuffer`.

## Dependencies

- Internal imports: `lib/export/types.ts`
- External imports: `pdfkit`
...
- Imported by: `lib/export/index.ts`, `lib/export/pdf.test.ts`
...
`Runtime/framework → lib/export/pdf.ts → lib/export/types.ts`
