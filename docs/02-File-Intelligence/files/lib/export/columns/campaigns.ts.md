...
| Field | Value |
|---|---|
| Full path | `lib/export/columns/campaigns.ts` |
| Layer | Export |
...
Public symbols: `CAMPAIGN_EXPORT_COLUMNS`.
...
- Outputs: exports `CAMPAIGN_EXPORT_COLUMNS`.
...
- File size: 18 lines; 2 internal dependencies.
- Review database calls inside loops, unbounded list queries, and external calls when changing this file.

## Relationships

- Imported by: `app/api/campaigns/export/route.ts`
...
`Runtime/framework → lib/export/columns/campaigns.ts → types/db.ts / lib/export/types.ts`
