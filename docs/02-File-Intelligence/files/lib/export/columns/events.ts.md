...
| Field | Value |
|---|---|
| Full path | `lib/export/columns/events.ts` |
| Layer | Export |
...
Public symbols: `EVENT_EXPORT_COLUMNS`.
...
- Outputs: exports `EVENT_EXPORT_COLUMNS`.
...
- Imported by: `app/api/events/export/route.ts`, `lib/export/columns/events.test.ts`
...
`Runtime/framework → lib/export/columns/events.ts → types/db.ts / lib/export/types.ts`
