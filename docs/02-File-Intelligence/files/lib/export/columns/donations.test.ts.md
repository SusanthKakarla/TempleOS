...
| Field | Value |
|---|---|
| Full path | `lib/export/columns/donations.test.ts` |
| Layer | Testing |
| Category | Test |
...
- Inputs: imports from `vitest`, `@/types/db`, `./donations`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `types/db.ts`, `lib/export/columns/donations.ts`
...
- Imports: `types/db.ts`, `lib/export/columns/donations.ts`
...
`Runtime/framework → lib/export/columns/donations.test.ts → types/db.ts / lib/export/columns/donations.ts`
