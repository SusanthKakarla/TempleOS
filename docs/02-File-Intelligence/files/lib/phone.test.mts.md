...
- Inputs: imports from `vitest`, `./phone.mts`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/phone.mts`
...
- File size: 22 lines; 1 internal dependencies.
- Review database calls inside loops, unbounded list queries, and external calls when changing this file.

## Relationships

- Imported by: No internal dependent detected
- Imports: `lib/phone.mts`
...
`Runtime/framework → lib/phone.test.mts → lib/phone.mts`
