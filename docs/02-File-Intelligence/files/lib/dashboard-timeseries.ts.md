...
| Field | Value |
|---|---|
| Full path | `lib/dashboard-timeseries.ts` |
| Layer | lib |
...
- Imported by: `app/(dashboard)/dashboard/page.tsx`, `lib/dashboard-timeseries.test.ts`
...
`Runtime/framework → lib/dashboard-timeseries.ts → output or side effect`
