...
| Field | Value |
|---|---|
| Full path | `components/empty-state.tsx` |
| Layer | Presentation |
...
`Runtime/framework → components/empty-state.tsx → lib/utils.ts`
