...
| Field | Value |
|---|---|
| Full path | `components/site-footer.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `next/link`, `lucide-react`, `@/components/ui/separator`.
- Outputs: exports `SiteFooter`.

## Dependencies

- Internal imports: `components/ui/separator.tsx`
...
- File size: 69 lines; 1 internal dependencies.
- Review database calls inside loops, unbounded list queries, and external calls when changing this file.

## Relationships

- Imported by: `app/(marketing)/layout.tsx`
- Imports: `components/ui/separator.tsx`
...
`Runtime/framework → components/site-footer.tsx → components/ui/separator.tsx`
