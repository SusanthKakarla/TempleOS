...
| Field | Value |
|---|---|
| Full path | `components/legal/table-of-contents.tsx` |
| Layer | Presentation |
...
Public symbols: `LegalTocEntry`, `TableOfContents`.
...
- Outputs: exports `LegalTocEntry`, `TableOfContents`.
...
- File size: 74 lines; 1 internal dependencies.
...
`Runtime/framework → components/legal/table-of-contents.tsx → lib/utils.ts`
