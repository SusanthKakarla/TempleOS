...
| Field | Value |
|---|---|
| Full path | `components/sortable-table-head.tsx` |
| Layer | Presentation |
...
Public symbols: `SortableTableHead`.
...
- Inputs: imports from `next/link`, `next/navigation`, `lucide-react`, `@/components/ui/table`, `@/lib/utils`, `@/lib/url-params`.
- Outputs: exports `SortableTableHead`.

## Dependencies

- Internal imports: `components/ui/table.tsx`, `lib/utils.ts`, `lib/url-params.ts`
...
- Imports: `components/ui/table.tsx`, `lib/utils.ts`, `lib/url-params.ts`
...
`Runtime/framework → components/sortable-table-head.tsx → components/ui/table.tsx / lib/utils.ts / lib/url-params.ts`
