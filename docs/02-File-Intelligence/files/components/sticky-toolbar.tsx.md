...
| Field | Value |
|---|---|
| Full path | `components/sticky-toolbar.tsx` |
| Layer | Presentation |
...
- Imported by: `features/devotees/devotees-table.tsx`, `features/users/users-table.tsx`
...
`Runtime/framework → components/sticky-toolbar.tsx → lib/utils.ts`
