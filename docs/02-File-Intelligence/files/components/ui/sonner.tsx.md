...
| Field | Value |
|---|---|
| Full path | `components/ui/sonner.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `@/lib/use-resolved-theme`, `sonner`, `lucide-react`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/use-resolved-theme.ts`
- External imports: `sonner`, `lucide-react`
...
- Imports: `lib/use-resolved-theme.ts`
...
`Runtime/framework → components/ui/sonner.tsx → lib/use-resolved-theme.ts`
