...
| Field | Value |
|---|---|
| Full path | `components/ui/switch.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `@base-ui/react/switch`, `@/lib/utils`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/utils.ts`
- External imports: `@base-ui/react/switch`
...
`Runtime/framework → components/ui/switch.tsx → lib/utils.ts`
