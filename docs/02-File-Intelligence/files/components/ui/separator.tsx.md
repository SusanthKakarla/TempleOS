...
| Field | Value |
|---|---|
| Full path | `components/ui/separator.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `@base-ui/react/separator`, `@/lib/utils`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/utils.ts`
- External imports: `@base-ui/react/separator`
...
- File size: 26 lines; 1 internal dependencies.
- Review database calls inside loops, unbounded list queries, and external calls when changing this file.

## Relationships

- Imported by: `components/site-footer.tsx`, `components/ui/sidebar.tsx`, `features/dashboard/dashboard-topbar.tsx`, `features/super-admin/super-admin-topbar.tsx`
...
`Runtime/framework → components/ui/separator.tsx → lib/utils.ts`
