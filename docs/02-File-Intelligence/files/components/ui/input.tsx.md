...
| Field | Value |
|---|---|
| Full path | `components/ui/input.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `react`, `@base-ui/react/input`, `@/lib/utils`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/utils.ts`
- External imports: `react`, `@base-ui/react/input`
...
`Runtime/framework → components/ui/input.tsx → lib/utils.ts`
