...
| Field | Value |
|---|---|
| Full path | `components/ui/table.tsx` |
| Layer | Presentation |
...
Shared UI Component in the **Presentation** area. It updates records.
...
`Runtime/framework → components/ui/table.tsx → lib/utils.ts`
