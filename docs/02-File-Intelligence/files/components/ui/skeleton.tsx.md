...
| Field | Value |
|---|---|
| Full path | `components/ui/skeleton.tsx` |
| Layer | Presentation |
...
- Imported by: `app/(dashboard)/dashboard/chatbot-settings/loading.tsx`, `app/(dashboard)/dashboard/devotees/[id]/loading.tsx`, `app/(dashboard)/dashboard/devotees/loading.tsx`, `app/(dashboard)/dashboard/donations/loading.tsx`, `app/(dashboard)/dashboard/loading.tsx`, `components/table-skeleton.tsx`, `components/ui/sidebar.tsx`
...
`Runtime/framework → components/ui/skeleton.tsx → lib/utils.ts`
