...
| Field | Value |
|---|---|
| Full path | `components/ui/tooltip.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `@base-ui/react/tooltip`, `@/lib/utils`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/utils.ts`
- External imports: `@base-ui/react/tooltip`
...
- File size: 67 lines; 1 internal dependencies.
- Review database calls inside loops, unbounded list queries, and external calls when changing this file.

## Relationships

- Imported by: `app/layout.tsx`, `components/ui/sidebar.tsx`
...
`Runtime/framework → components/ui/tooltip.tsx → lib/utils.ts`
