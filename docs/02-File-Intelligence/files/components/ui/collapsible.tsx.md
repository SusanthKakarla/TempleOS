...
| Field | Value |
|---|---|
| Full path | `components/ui/collapsible.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `@base-ui/react/collapsible`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: None detected
- External imports: `@base-ui/react/collapsible`
...
- Imported by: `features/chatbot-settings/settings-section.tsx`
...
`Runtime/framework → components/ui/collapsible.tsx → output or side effect`
