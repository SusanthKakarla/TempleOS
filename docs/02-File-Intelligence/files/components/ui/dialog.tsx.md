...
| Field | Value |
|---|---|
| Full path | `components/ui/dialog.tsx` |
| Layer | Presentation |
...
- File size: 161 lines; 2 internal dependencies.
...
`Runtime/framework → components/ui/dialog.tsx → lib/utils.ts / components/ui/button.tsx`
