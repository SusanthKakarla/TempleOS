...
| Field | Value |
|---|---|
| Full path | `components/ui/checkbox.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `@base-ui/react/checkbox`, `@/lib/utils`, `lucide-react`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/utils.ts`
- External imports: `@base-ui/react/checkbox`, `lucide-react`
...
`Runtime/framework → components/ui/checkbox.tsx → lib/utils.ts`
