...
| Field | Value |
|---|---|
| Full path | `components/ui/breadcrumb.tsx` |
| Layer | Presentation |
...
- Inputs: imports from `react`, `@base-ui/react/merge-props`, `@base-ui/react/use-render`, `@/lib/utils`, `lucide-react`.
- Outputs: side effects or static artifact.

## Dependencies

- Internal imports: `lib/utils.ts`
- External imports: `react`, `@base-ui/react/merge-props`, `@base-ui/react/use-render`, `lucide-react`
...
- File size: 126 lines; 1 internal dependencies.
- Review database calls inside loops, unbounded list queries, and external calls when changing this file.

## Relationships

- Imported by: `components/legal/legal-hero.tsx`, `features/dashboard/dashboard-topbar.tsx`, `features/super-admin/super-admin-topbar.tsx`
...
`Runtime/framework → components/ui/breadcrumb.tsx → lib/utils.ts`
