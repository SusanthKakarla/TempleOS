...
| Field | Value |
|---|---|
| Full path | `components/table-shell.tsx` |
| Layer | Presentation |
...
`Runtime/framework → components/table-shell.tsx → lib/utils.ts`
