...
Documentation in the **Documentation** area. It calls an external api, processes notifications/messages.
...
- Tables referenced: `tenants`, `whatsapp_accounts`, `events`, `devotees`, `whatsapp_messages`, `whatsapp_interactions`, `donations`
...
- File size: 575 lines; 0 internal dependencies.
...
`Runtime/framework → MVP_SPEC.md → output or side effect`
