...
| Field | Value |
|---|---|
| Full path | `app/api/super-admin/temples/route.test.ts` |
| Layer | Testing |
| Category | Test |
...
- Internal imports: `app/api/super-admin/temples/route.ts`, `lib/auth/super-admin-session.ts`, `lib/auth/session.ts`, `lib/db/tenants.ts`, `lib/provisioning/temples.ts`
...
- File size: 459 lines; 5 internal dependencies.
- Review database calls inside loops, unbounded list queries, and external calls when changing this file.

## Relationships

- Imported by: No internal dependent detected
- Imports: `app/api/super-admin/temples/route.ts`, `lib/auth/super-admin-session.ts`, `lib/auth/session.ts`, `lib/db/tenants.ts`, `lib/provisioning/temples.ts`
...
`Runtime/framework → app/api/super-admin/temples/route.test.ts → app/api/super-admin/temples/route.ts / lib/auth/super-admin-session.ts / lib/auth/session.ts / lib/db/tenants.ts`
