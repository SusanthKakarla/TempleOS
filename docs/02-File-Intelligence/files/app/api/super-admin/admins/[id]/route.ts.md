...
| Field | Value |
|---|---|
| Full path | `app/api/super-admin/admins/[id]/route.ts` |
| Layer | Super Admin |
| Category | API Route |
...
`Runtime/framework → app/api/super-admin/admins/[id]/route.ts → lib/auth/super-admin-session.ts / lib/auth/session.ts / lib/db/super-admins.ts / lib/db/audit-log.ts`
