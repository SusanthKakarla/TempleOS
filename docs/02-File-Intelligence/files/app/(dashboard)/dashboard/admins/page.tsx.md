...
| Field | Value |
|---|---|
| Full path | `app/(dashboard)/dashboard/admins/page.tsx` |
| Layer | Presentation |
| Category | Page |
...
- Inputs: imports from `next/navigation`.
- Outputs: exports `AdminsPage`.
...
`Runtime/framework → app/(dashboard)/dashboard/admins/page.tsx → output or side effect`
