...
| Field | Value |
|---|---|
| Full path | `features/dashboard/use-count-up.ts` |
| Layer | Dashboard |
...
- Imported by: `features/dashboard/metric-card.tsx`
...
`Runtime/framework → features/dashboard/use-count-up.ts → output or side effect`
