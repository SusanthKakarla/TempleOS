...
| Field | Value |
|---|---|
| Full path | `features/dashboard/ambient-background.tsx` |
| Layer | Dashboard |
...
Public symbols: `AmbientBackground`.
...
- Outputs: exports `AmbientBackground`.
...
- File size: 12 lines; 0 internal dependencies.
- Review database calls inside loops, unbounded list queries, and external calls when changing this file.

## Relationships

- Imported by: `app/(auth)/access-denied/page.tsx`, `app/(auth)/login/page.tsx`, `app/whatsapp-onboarding/page.tsx`, `features/dashboard/dashboard-shell.tsx`, `features/super-admin/super-admin-login-form.tsx`, `features/super-admin/super-admin-shell.tsx`
...
`Runtime/framework → features/dashboard/ambient-background.tsx → output or side effect`
