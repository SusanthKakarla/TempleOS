...
| Field | Value |
|---|---|
| Full path | `locales/en/dashboard.json` |
...
Localization in the **Internationalization** area. It reads database, updates records, deletes records, processes notifications/messages, uploads/processes media.
...
- File size: 1197 lines; 0 internal dependencies.
...
`Runtime/framework → locales/en/dashboard.json → output or side effect`
