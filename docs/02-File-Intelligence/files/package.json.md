...
Configuration in the **Configuration** area. It calls an external api, uploads/processes media.
...
- External integration indicators: Firebase ImageKit
...
- File size: 65 lines; 0 internal dependencies.
...
`Runtime/framework → package.json → output or side effect`
