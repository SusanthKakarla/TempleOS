# 015_feature_access.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/015_feature_access.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `tenants`, `super_admins`, `features`, `tenant_features`
...
`Runtime/framework → migrations/015_feature_access.sql → output or side effect`
