# 007_event_notifications.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/007_event_notifications.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `tenants`, `events`, `devotees`, `whatsapp_messages`, `event_notifications`, `notifications`
...
- File size: 43 lines; 0 internal dependencies.
...
`Runtime/framework → migrations/007_event_notifications.sql → output or side effect`
