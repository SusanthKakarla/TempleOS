# 017_notification_delivery_tracking.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/017_notification_delivery_tracking.sql` |
| Layer | Database |
| Category | Migration |
...
Migration in the **Database** area. It processes notifications/messages.
...
- Tables referenced: `whatsapp_messages`, `notifications`
...
`Runtime/framework → migrations/017_notification_delivery_tracking.sql → output or side effect`
