# 012_whatsapp_embedded_signup.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/012_whatsapp_embedded_signup.sql` |
| Layer | Database |
| Category | Migration |
...
`Runtime/framework → migrations/012_whatsapp_embedded_signup.sql → output or side effect`
