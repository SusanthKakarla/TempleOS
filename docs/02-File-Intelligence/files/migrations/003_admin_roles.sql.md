...
| Field | Value |
|---|---|
| Full path | `migrations/003_admin_roles.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `super_admins`, `persons`, `role_definitions`, `tenant_memberships`, `tenant_membership_roles`
...
`Runtime/framework → migrations/003_admin_roles.sql → output or side effect`
