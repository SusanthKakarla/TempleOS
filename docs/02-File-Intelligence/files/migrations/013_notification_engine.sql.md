# 013_notification_engine.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/013_notification_engine.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `tenants`, `persons`, `devotees`, `audit_log`, `event_notifications`, `notification_templates`, `notifications`, `notification_preferences`
...
- File size: 63 lines; 0 internal dependencies.
...
`Runtime/framework → migrations/013_notification_engine.sql → output or side effect`
