# 018_devotee_lifecycle.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/018_devotee_lifecycle.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `tenant_memberships`, `devotees`, `devotee_families`
...
`Runtime/framework → migrations/018_devotee_lifecycle.sql → output or side effect`
