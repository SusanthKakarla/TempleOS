...
| Field | Value |
|---|---|
| Full path | `migrations/021_campaigns.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `tenants`, `tenant_memberships`, `events`, `audit_log`, `notifications`, `notification_media`, `campaigns`
...
`Runtime/framework → migrations/021_campaigns.sql → output or side effect`
