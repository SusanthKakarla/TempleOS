# 009_dashboard_locale.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/009_dashboard_locale.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `tenant_memberships`, `devotees`
...
`Runtime/framework → migrations/009_dashboard_locale.sql → output or side effect`
