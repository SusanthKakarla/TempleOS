# 014_whatsapp_account_uniqueness.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/014_whatsapp_account_uniqueness.sql` |
| Layer | Database |
| Category | Migration |
...
`Runtime/framework → migrations/014_whatsapp_account_uniqueness.sql → output or side effect`
