# 010_tenant_membership_last_login.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/010_tenant_membership_last_login.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `tenant_memberships`
...
`Runtime/framework → migrations/010_tenant_membership_last_login.sql → output or side effect`
