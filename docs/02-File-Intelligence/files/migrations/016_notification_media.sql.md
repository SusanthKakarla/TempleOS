# 016_notification_media.sql

## Basic Information

| Field | Value |
|---|---|
| Full path | `migrations/016_notification_media.sql` |
| Layer | Database |
| Category | Migration |
...
- Tables referenced: `tenants`, `tenant_memberships`, `events`, `notification_templates`, `notifications`, `notification_media`, `tenant_notification_media`
...
- File size: 44 lines; 0 internal dependencies.
...
`Runtime/framework → migrations/016_notification_media.sql → output or side effect`
