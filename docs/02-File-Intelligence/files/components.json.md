...
| Field | Value |
|---|---|
| Full path | `components.json` |
| Layer | components.json |
| Category | Asset |
...
Asset in the **components.json** area. It defines project behavior, structure, data, or configuration consumed by its dependents.
...
`Runtime/framework → components.json → output or side effect`
