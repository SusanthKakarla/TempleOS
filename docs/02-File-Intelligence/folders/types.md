...
The `types/` folder belongs primarily to the **types** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Types behavior or assets.
