...
The `i18n/` folder belongs primarily to the **Internationalization** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate I18n behavior or assets.
...
- [`request.ts`](../files/i18n/request.ts.md)
