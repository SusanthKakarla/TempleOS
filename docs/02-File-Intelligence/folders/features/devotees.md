# Folder: features/devotees

## Purpose

The `features/devotees/` folder belongs primarily to the **Devotees** area and groups 4 direct documented files.

## Responsibilities and Business Module

- Encapsulate Devotees behavior or assets.
...
- [`devotee-form-dialog.tsx`](../../files/features/devotees/devotee-form-dialog.tsx.md)
- [`devotee-import-wizard.tsx`](../../files/features/devotees/devotee-import-wizard.tsx.md)
- [`devotees-table.tsx`](../../files/features/devotees/devotees-table.tsx.md)
- [`family-form-wizard.tsx`](../../files/features/devotees/family-form-wizard.tsx.md)
