# Folder: features/export

## Purpose

The `features/export/` folder belongs primarily to the **Export** area and groups 1 direct documented files.
...
- [`export-menu.tsx`](../../files/features/export/export-menu.tsx.md)
