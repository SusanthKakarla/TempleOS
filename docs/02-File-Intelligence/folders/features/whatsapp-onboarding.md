# Folder: features/whatsapp-onboarding

## Purpose

The `features/whatsapp-onboarding/` folder belongs primarily to the **Whatsapp Onboarding** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Whatsapp Onboarding behavior or assets.
...
- [`whatsapp-onboarding-flow.tsx`](../../files/features/whatsapp-onboarding/whatsapp-onboarding-flow.tsx.md)
