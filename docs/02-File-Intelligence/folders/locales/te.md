...
The `locales/te/` folder belongs primarily to the **Internationalization** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Te behavior or assets.
...
- [`dashboard.json`](../../files/locales/te/dashboard.json.md)
