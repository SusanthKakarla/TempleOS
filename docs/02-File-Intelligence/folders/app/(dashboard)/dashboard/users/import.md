# Folder: app/(dashboard)/dashboard/users/import

## Purpose

The `app/(dashboard)/dashboard/users/import/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`page.tsx`](../../../../../files/app/%28dashboard%29/dashboard/users/import/page.tsx.md)
