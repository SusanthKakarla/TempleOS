# Folder: app/(dashboard)/dashboard/campaigns/[id]

## Purpose

The `app/(dashboard)/dashboard/campaigns/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`page.tsx`](../../../../../files/app/%28dashboard%29/dashboard/campaigns/%5Bid%5D/page.tsx.md)
