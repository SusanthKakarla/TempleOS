# Folder: app/(dashboard)/dashboard/devotees

## Purpose

The `app/(dashboard)/dashboard/devotees/` folder belongs primarily to the **app** area and groups 2 direct documented files.
...
- [`loading.tsx`](../../../../files/app/%28dashboard%29/dashboard/devotees/loading.tsx.md)
- [`page.tsx`](../../../../files/app/%28dashboard%29/dashboard/devotees/page.tsx.md)

## Child Folders

- `app/(dashboard)/dashboard/devotees/[id]/`
- `app/(dashboard)/dashboard/devotees/import/`
