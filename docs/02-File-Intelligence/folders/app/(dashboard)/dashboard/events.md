# Folder: app/(dashboard)/dashboard/events

## Purpose

The `app/(dashboard)/dashboard/events/` folder belongs primarily to the **app** area and groups 2 direct documented files.
...
- [`loading.tsx`](../../../../files/app/%28dashboard%29/dashboard/events/loading.tsx.md)
- [`page.tsx`](../../../../files/app/%28dashboard%29/dashboard/events/page.tsx.md)
