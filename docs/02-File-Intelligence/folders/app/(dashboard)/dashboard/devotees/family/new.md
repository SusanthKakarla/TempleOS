# Folder: app/(dashboard)/dashboard/devotees/family/new

## Purpose

The `app/(dashboard)/dashboard/devotees/family/new/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`page.tsx`](../../../../../../files/app/%28dashboard%29/dashboard/devotees/family/new/page.tsx.md)
