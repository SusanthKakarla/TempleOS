# Folder: app/(dashboard)/dashboard/devotees/import

## Purpose

The `app/(dashboard)/dashboard/devotees/import/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Import behavior or assets.
...
- [`page.tsx`](../../../../../files/app/%28dashboard%29/dashboard/devotees/import/page.tsx.md)
