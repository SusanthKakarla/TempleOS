# Folder: app/(dashboard)/dashboard/chatbot-settings

## Purpose

The `app/(dashboard)/dashboard/chatbot-settings/` folder belongs primarily to the **app** area and groups 3 direct documented files.
...
- [`error.tsx`](../../../../files/app/%28dashboard%29/dashboard/chatbot-settings/error.tsx.md)
- [`loading.tsx`](../../../../files/app/%28dashboard%29/dashboard/chatbot-settings/loading.tsx.md)
- [`page.tsx`](../../../../files/app/%28dashboard%29/dashboard/chatbot-settings/page.tsx.md)
