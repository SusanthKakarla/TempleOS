# Folder: app/(super-admin)/super-admin/(shell)/roles

## Purpose

The `app/(super-admin)/super-admin/(shell)/roles/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`page.tsx`](../../../../../files/app/%28super-admin%29/super-admin/%28shell%29/roles/page.tsx.md)
