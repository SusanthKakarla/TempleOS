# Folder: app/(super-admin)/super-admin/(shell)/temples/new

## Purpose

The `app/(super-admin)/super-admin/(shell)/temples/new/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate New behavior or assets.
...
- [`page.tsx`](../../../../../../files/app/%28super-admin%29/super-admin/%28shell%29/temples/new/page.tsx.md)
