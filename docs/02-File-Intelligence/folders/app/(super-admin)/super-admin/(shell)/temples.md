# Folder: app/(super-admin)/super-admin/(shell)/temples

## Purpose

The `app/(super-admin)/super-admin/(shell)/temples/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Temples behavior or assets.
...
- [`page.tsx`](../../../../../files/app/%28super-admin%29/super-admin/%28shell%29/temples/page.tsx.md)

## Child Folders

- `app/(super-admin)/super-admin/(shell)/temples/[tenantId]/`
- `app/(super-admin)/super-admin/(shell)/temples/new/`
