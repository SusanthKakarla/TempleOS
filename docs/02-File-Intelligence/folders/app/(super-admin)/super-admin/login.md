# Folder: app/(super-admin)/super-admin/login

## Purpose

The `app/(super-admin)/super-admin/login/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`page.tsx`](../../../../files/app/%28super-admin%29/super-admin/login/page.tsx.md)
