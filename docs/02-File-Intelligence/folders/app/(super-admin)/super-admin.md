# Folder: app/(super-admin)/super-admin

## Purpose

The `app/(super-admin)/super-admin/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`require-super-admin.ts`](../../../files/app/%28super-admin%29/super-admin/require-super-admin.ts.md)

## Child Folders

- `app/(super-admin)/super-admin/(shell)/`
- `app/(super-admin)/super-admin/login/`
