...
The `app/(dashboard)/` folder belongs primarily to the **app** area and groups 2 direct documented files.
...
- [`layout.tsx`](../../files/app/%28dashboard%29/layout.tsx.md)
- [`template.tsx`](../../files/app/%28dashboard%29/template.tsx.md)
