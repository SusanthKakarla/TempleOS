# Folder: app/api/notification-preferences

## Purpose

The `app/api/notification-preferences/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../files/app/api/notification-preferences/route.ts.md)
