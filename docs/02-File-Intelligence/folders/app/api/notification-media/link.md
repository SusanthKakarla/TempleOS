# Folder: app/api/notification-media/link

## Purpose

The `app/api/notification-media/link/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Link behavior or assets.
...
- [`route.ts`](../../../../files/app/api/notification-media/link/route.ts.md)
