# Folder: app/api/donations/[id]

## Purpose

The `app/api/donations/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/donations/%5Bid%5D/route.ts.md)
