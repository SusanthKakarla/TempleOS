# Folder: app/api/donations/export

## Purpose

The `app/api/donations/export/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/donations/export/route.ts.md)
