# Folder: app/api/temple-special-days

## Purpose

The `app/api/temple-special-days/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Temple Special Days behavior or assets.
...
- [`route.ts`](../../../files/app/api/temple-special-days/route.ts.md)

## Child Folders

- `app/api/temple-special-days/[id]/`
