# Folder: app/api/events/[id]

## Purpose

The `app/api/events/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/events/%5Bid%5D/route.ts.md)

## Child Folders

- `app/api/events/[id]/announce/`
