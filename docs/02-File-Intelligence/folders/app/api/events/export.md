# Folder: app/api/events/export

## Purpose

The `app/api/events/export/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/events/export/route.ts.md)
