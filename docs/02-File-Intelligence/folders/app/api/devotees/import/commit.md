# Folder: app/api/devotees/import/commit

## Purpose

The `app/api/devotees/import/commit/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Commit behavior or assets.
...
- [`route.ts`](../../../../../files/app/api/devotees/import/commit/route.ts.md)
