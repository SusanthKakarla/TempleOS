# Folder: app/api/devotees/import/preview

## Purpose

The `app/api/devotees/import/preview/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Preview behavior or assets.
...
- [`route.ts`](../../../../../files/app/api/devotees/import/preview/route.ts.md)
