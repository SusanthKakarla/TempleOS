# Folder: app/api/devotees/export

## Purpose

The `app/api/devotees/export/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/devotees/export/route.ts.md)
