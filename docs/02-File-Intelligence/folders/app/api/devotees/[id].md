# Folder: app/api/devotees/[id]

## Purpose

The `app/api/devotees/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/devotees/%5Bid%5D/route.ts.md)

## Child Folders

- `app/api/devotees/[id]/donations/`
- `app/api/devotees/[id]/status/`
