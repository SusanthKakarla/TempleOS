# Folder: app/api/devotees/families/[id]

## Purpose

The `app/api/devotees/families/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/devotees/families/%5Bid%5D/route.ts.md)
