# Folder: app/api/devotees/[id]/donations

## Purpose

The `app/api/devotees/[id]/donations/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/devotees/%5Bid%5D/donations/route.ts.md)
