# Folder: app/api/devotees/[id]/status

## Purpose

The `app/api/devotees/[id]/status/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/devotees/%5Bid%5D/status/route.ts.md)
