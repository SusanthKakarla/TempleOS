# Folder: app/api/users/import/commit

## Purpose

The `app/api/users/import/commit/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/users/import/commit/route.ts.md)
