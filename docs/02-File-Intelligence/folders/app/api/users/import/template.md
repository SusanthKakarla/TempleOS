# Folder: app/api/users/import/template

## Purpose

The `app/api/users/import/template/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/users/import/template/route.ts.md)
