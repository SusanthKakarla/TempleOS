# Folder: app/api/users/export

## Purpose

The `app/api/users/export/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/users/export/route.ts.md)
