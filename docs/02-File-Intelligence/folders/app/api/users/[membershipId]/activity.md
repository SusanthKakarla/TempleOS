# Folder: app/api/users/[membershipId]/activity

## Purpose

The `app/api/users/[membershipId]/activity/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/users/%5BmembershipId%5D/activity/route.ts.md)
