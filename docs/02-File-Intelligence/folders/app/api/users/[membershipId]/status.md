# Folder: app/api/users/[membershipId]/status

## Purpose

The `app/api/users/[membershipId]/status/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/users/%5BmembershipId%5D/status/route.ts.md)
