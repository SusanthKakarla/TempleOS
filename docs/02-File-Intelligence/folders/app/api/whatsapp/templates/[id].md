# Folder: app/api/whatsapp/templates/[id]

## Purpose

The `app/api/whatsapp/templates/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/whatsapp/templates/%5Bid%5D/route.ts.md)

## Child Folders

- `app/api/whatsapp/templates/[id]/sync/`
- `app/api/whatsapp/templates/[id]/test-send/`
