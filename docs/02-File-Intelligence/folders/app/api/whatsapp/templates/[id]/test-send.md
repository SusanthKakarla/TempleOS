# Folder: app/api/whatsapp/templates/[id]/test-send

## Purpose

The `app/api/whatsapp/templates/[id]/test-send/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Test Send behavior or assets.
...
- [`route.ts`](../../../../../../files/app/api/whatsapp/templates/%5Bid%5D/test-send/route.ts.md)
