# Folder: app/api/whatsapp/templates/[id]/sync

## Purpose

The `app/api/whatsapp/templates/[id]/sync/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Sync behavior or assets.
...
- [`route.ts`](../../../../../../files/app/api/whatsapp/templates/%5Bid%5D/sync/route.ts.md)
