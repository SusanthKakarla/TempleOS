# Folder: app/api/whatsapp/disconnect

## Purpose

The `app/api/whatsapp/disconnect/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Disconnect behavior or assets.
...
- [`route.ts`](../../../../files/app/api/whatsapp/disconnect/route.ts.md)
