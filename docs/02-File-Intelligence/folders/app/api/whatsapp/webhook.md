# Folder: app/api/whatsapp/webhook

## Purpose

The `app/api/whatsapp/webhook/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Webhook behavior or assets.
...
- [`route.ts`](../../../../files/app/api/whatsapp/webhook/route.ts.md)
