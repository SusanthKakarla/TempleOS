# Folder: app/api/whatsapp/connect/callback

## Purpose

The `app/api/whatsapp/connect/callback/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Callback behavior or assets.
...
- [`route.ts`](../../../../../files/app/api/whatsapp/connect/callback/route.ts.md)
