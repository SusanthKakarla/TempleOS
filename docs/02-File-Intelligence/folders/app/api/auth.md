...
The `app/api/auth/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`auth-boundary.test.ts`](../../../files/app/api/auth/auth-boundary.test.ts.md)

## Child Folders

- `app/api/auth/session/`
- `app/api/auth/tenant-context/`
