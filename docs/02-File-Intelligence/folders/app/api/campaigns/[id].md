# Folder: app/api/campaigns/[id]

## Purpose

The `app/api/campaigns/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/campaigns/%5Bid%5D/route.ts.md)

## Child Folders

- `app/api/campaigns/[id]/analytics/`
- `app/api/campaigns/[id]/duplicate/`
- `app/api/campaigns/[id]/schedule/`
- `app/api/campaigns/[id]/send/`
- `app/api/campaigns/[id]/status/`
