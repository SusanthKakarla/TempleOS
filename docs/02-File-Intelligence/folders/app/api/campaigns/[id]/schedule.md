# Folder: app/api/campaigns/[id]/schedule

## Purpose

The `app/api/campaigns/[id]/schedule/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Schedule behavior or assets.
...
- [`route.ts`](../../../../../files/app/api/campaigns/%5Bid%5D/schedule/route.ts.md)
