# Folder: app/api/campaigns/[id]/duplicate

## Purpose

The `app/api/campaigns/[id]/duplicate/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Duplicate behavior or assets.
...
- [`route.ts`](../../../../../files/app/api/campaigns/%5Bid%5D/duplicate/route.ts.md)
