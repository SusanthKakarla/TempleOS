# Folder: app/api/campaigns/[id]/status

## Purpose

The `app/api/campaigns/[id]/status/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/campaigns/%5Bid%5D/status/route.ts.md)
