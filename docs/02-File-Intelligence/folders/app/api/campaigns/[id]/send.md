# Folder: app/api/campaigns/[id]/send

## Purpose

The `app/api/campaigns/[id]/send/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Send behavior or assets.
...
- [`route.ts`](../../../../../files/app/api/campaigns/%5Bid%5D/send/route.ts.md)
