# Folder: app/api/campaigns/export

## Purpose

The `app/api/campaigns/export/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/campaigns/export/route.ts.md)
