# Folder: app/api/cron/sync-whatsapp-templates

## Purpose

The `app/api/cron/sync-whatsapp-templates/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Sync Whatsapp Templates behavior or assets.
...
- [`route.ts`](../../../../files/app/api/cron/sync-whatsapp-templates/route.ts.md)
