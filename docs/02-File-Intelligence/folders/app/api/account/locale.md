# Folder: app/api/account/locale

## Purpose

The `app/api/account/locale/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Locale behavior or assets.
...
- [`route.ts`](../../../../files/app/api/account/locale/route.ts.md)
