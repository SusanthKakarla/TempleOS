# Folder: app/api/temple-social-links/[platform]

## Purpose

The `app/api/temple-social-links/[platform]/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate [Platform] behavior or assets.
...
- [`route.ts`](../../../../files/app/api/temple-social-links/%5Bplatform%5D/route.ts.md)
