# Folder: app/api/temple-faqs/[id]

## Purpose

The `app/api/temple-faqs/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/temple-faqs/%5Bid%5D/route.ts.md)
