# Folder: app/api/campaigns

## Purpose

The `app/api/campaigns/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../files/app/api/campaigns/route.ts.md)

## Child Folders

- `app/api/campaigns/[id]/`
- `app/api/campaigns/audience-preview/`
- `app/api/campaigns/export/`
