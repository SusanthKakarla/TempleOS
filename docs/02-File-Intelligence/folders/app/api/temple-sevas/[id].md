# Folder: app/api/temple-sevas/[id]

## Purpose

The `app/api/temple-sevas/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/temple-sevas/%5Bid%5D/route.ts.md)
