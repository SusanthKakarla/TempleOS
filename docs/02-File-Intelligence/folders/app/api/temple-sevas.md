# Folder: app/api/temple-sevas

## Purpose

The `app/api/temple-sevas/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Temple Sevas behavior or assets.
...
- [`route.ts`](../../../files/app/api/temple-sevas/route.ts.md)

## Child Folders

- `app/api/temple-sevas/[id]/`
