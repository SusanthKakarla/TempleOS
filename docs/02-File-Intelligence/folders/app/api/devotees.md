# Folder: app/api/devotees

## Purpose

The `app/api/devotees/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../files/app/api/devotees/route.ts.md)

## Child Folders

- `app/api/devotees/[id]/`
- `app/api/devotees/export/`
- `app/api/devotees/families/`
