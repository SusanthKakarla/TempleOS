# Folder: app/api/temple-special-days/[id]

## Purpose

The `app/api/temple-special-days/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/temple-special-days/%5Bid%5D/route.ts.md)
