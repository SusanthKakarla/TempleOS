# Folder: app/api/auth/session

## Purpose

The `app/api/auth/session/` folder belongs primarily to the **app** area and groups 2 direct documented files.
...
- [`route.test.ts`](../../../../files/app/api/auth/session/route.test.ts.md)
- [`route.ts`](../../../../files/app/api/auth/session/route.ts.md)
