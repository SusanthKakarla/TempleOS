# Folder: app/api/super-admin/me

## Purpose

The `app/api/super-admin/me/` folder belongs primarily to the **app** area and groups 2 direct documented files.

## Responsibilities and Business Module

- Encapsulate Me behavior or assets.
...
- [`route.test.ts`](../../../../files/app/api/super-admin/me/route.test.ts.md)
- [`route.ts`](../../../../files/app/api/super-admin/me/route.ts.md)
