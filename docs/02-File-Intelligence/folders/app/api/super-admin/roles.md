# Folder: app/api/super-admin/roles

## Purpose

The `app/api/super-admin/roles/` folder belongs primarily to the **app** area and groups 2 direct documented files.
...
- [`route.test.ts`](../../../../files/app/api/super-admin/roles/route.test.ts.md)
- [`route.ts`](../../../../files/app/api/super-admin/roles/route.ts.md)
