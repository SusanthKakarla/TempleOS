# Folder: app/api/super-admin/temples

## Purpose

The `app/api/super-admin/temples/` folder belongs primarily to the **app** area and groups 2 direct documented files.
...
- [`route.test.ts`](../../../../files/app/api/super-admin/temples/route.test.ts.md)
- [`route.ts`](../../../../files/app/api/super-admin/temples/route.ts.md)

## Child Folders

- `app/api/super-admin/temples/[tenantId]/`
