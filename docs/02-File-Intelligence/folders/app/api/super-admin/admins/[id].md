# Folder: app/api/super-admin/admins/[id]

## Purpose

The `app/api/super-admin/admins/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../files/app/api/super-admin/admins/%5Bid%5D/route.ts.md)
