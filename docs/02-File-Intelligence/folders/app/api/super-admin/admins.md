# Folder: app/api/super-admin/admins

## Purpose

The `app/api/super-admin/admins/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/super-admin/admins/route.ts.md)

## Child Folders

- `app/api/super-admin/admins/[id]/`
