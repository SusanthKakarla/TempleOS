# Folder: app/api/super-admin/temples/[tenantId]

## Purpose

The `app/api/super-admin/temples/[tenantId]/` folder belongs primarily to the **app** area and groups 2 direct documented files.

## Responsibilities and Business Module

- Encapsulate [TenantId] behavior or assets.
...
- [`route.test.ts`](../../../../../files/app/api/super-admin/temples/%5BtenantId%5D/route.test.ts.md)
- [`route.ts`](../../../../../files/app/api/super-admin/temples/%5BtenantId%5D/route.ts.md)

## Child Folders

- `app/api/super-admin/temples/[tenantId]/features/`
- `app/api/super-admin/temples/[tenantId]/status/`
- `app/api/super-admin/temples/[tenantId]/whatsapp/`
