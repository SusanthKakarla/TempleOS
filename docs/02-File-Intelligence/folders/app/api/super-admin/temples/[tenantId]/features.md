# Folder: app/api/super-admin/temples/[tenantId]/features

## Purpose

The `app/api/super-admin/temples/[tenantId]/features/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Features behavior or assets.
...
- [`route.ts`](../../../../../../files/app/api/super-admin/temples/%5BtenantId%5D/features/route.ts.md)
