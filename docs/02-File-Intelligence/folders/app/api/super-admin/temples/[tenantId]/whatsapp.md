# Folder: app/api/super-admin/temples/[tenantId]/whatsapp

## Purpose

The `app/api/super-admin/temples/[tenantId]/whatsapp/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../../../files/app/api/super-admin/temples/%5BtenantId%5D/whatsapp/route.ts.md)
