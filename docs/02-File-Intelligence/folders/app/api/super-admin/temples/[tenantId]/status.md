# Folder: app/api/super-admin/temples/[tenantId]/status

## Purpose

The `app/api/super-admin/temples/[tenantId]/status/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Status behavior or assets.
...
- [`route.ts`](../../../../../../files/app/api/super-admin/temples/%5BtenantId%5D/status/route.ts.md)
