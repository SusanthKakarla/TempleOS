# Folder: app/api/super-admin/temples/[tenantId]/members/[membershipId]/roles

## Purpose

The `app/api/super-admin/temples/[tenantId]/members/[membershipId]/roles/` folder belongs primarily to the **app** area and groups 2 direct documented files.

## Responsibilities and Business Module

- Encapsulate Roles behavior or assets.
...
- [`route.test.ts`](../../../../../../../../files/app/api/super-admin/temples/%5BtenantId%5D/members/%5BmembershipId%5D/roles/route.test.ts.md)
- [`route.ts`](../../../../../../../../files/app/api/super-admin/temples/%5BtenantId%5D/members/%5BmembershipId%5D/roles/route.ts.md)
