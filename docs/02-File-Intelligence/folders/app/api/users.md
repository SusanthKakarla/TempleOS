...
The `app/api/users/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../files/app/api/users/route.ts.md)

## Child Folders

- `app/api/users/[membershipId]/`
