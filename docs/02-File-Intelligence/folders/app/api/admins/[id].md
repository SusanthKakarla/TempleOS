# Folder: app/api/admins/[id]

## Purpose

The `app/api/admins/[id]/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`route.ts`](../../../../files/app/api/admins/%5Bid%5D/route.ts.md)
