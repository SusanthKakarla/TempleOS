# Folder: app/(auth)/access-denied

## Purpose

The `app/(auth)/access-denied/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Access Denied behavior or assets.
...
- [`page.tsx`](../../../files/app/%28auth%29/access-denied/page.tsx.md)
