# Folder: app/(marketing)/privacy-policy

## Purpose

The `app/(marketing)/privacy-policy/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Privacy Policy behavior or assets.
...
- [`page.tsx`](../../../files/app/%28marketing%29/privacy-policy/page.tsx.md)
