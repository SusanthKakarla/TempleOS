# Folder: app/(marketing)/terms-of-service

## Purpose

The `app/(marketing)/terms-of-service/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate Terms Of Service behavior or assets.
...
- [`page.tsx`](../../../files/app/%28marketing%29/terms-of-service/page.tsx.md)
