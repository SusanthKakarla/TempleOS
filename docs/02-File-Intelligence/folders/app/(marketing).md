...
The `app/(marketing)/` folder belongs primarily to the **app** area and groups 1 direct documented files.

## Responsibilities and Business Module

- Encapsulate (Marketing) behavior or assets.
...
- [`layout.tsx`](../../files/app/%28marketing%29/layout.tsx.md)

## Child Folders

- `app/(marketing)/privacy-policy/`
- `app/(marketing)/terms-of-service/`
