# Folder: app/whatsapp-onboarding

## Purpose

The `app/whatsapp-onboarding/` folder belongs primarily to the **app** area and groups 1 direct documented files.
...
- [`page.tsx`](../../files/app/whatsapp-onboarding/page.tsx.md)
