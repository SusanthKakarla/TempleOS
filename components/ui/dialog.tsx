  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "no-scrollbar glass-dialog fixed top-1/2 left-1/2 z-50 grid max-h-[85dvh] w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 overflow-x-hidden overflow-y-auto rounded-3xl p-4 text-sm text-popover-foreground duration-200 outline-none sm:max-w-sm data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      >
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-3xl border-t p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
